...
<div>
  <div class="swiper-container">
    <swiper id="v" :options="swiperOptionV">
      <swiper-slide id="slide1" style="background-image: url('img/bg/bg18.jpg');">
        <div id="header">
      ...
      <swiper-slide>
        <h2 class="-2 mt-5">I can help you with...</h2>
        <div class="row mt-5" id="help">
          <div class="col-md">
            <div class="text-center"><img src="img/home/web.svg"></div>
            <h3>Web Development</h3>
            <p>Establishing web presence contributes a lot to the success of your business. Let's build a <b>stunning website together</b>! Whether you want to use <b>CMS</b>, or<b>HTML, CSS, and JS</b>, or <b>JS frameworks</b> such as Vue.js and Angular,
              I am here to help! </p>
          </div>
          <div class="col-md">
            <div class="text-center"><img src="img/home/analysis.svg"></div>
            <h3>Research &amp; Planning</h3>
            <p><b>Research</b> is the cornerstone of any effective marketing strategy. However, data gathered from research are just raw facts without further meaning. Let me help you translate them into insights that <b>drive better decisions</b>.
            </p>
          </div>
          <div class="col-md">
            <div class="text-center"><img src="img/home/visual.svg"></div>
            <h3>Visual Design</h3>
            <p>Got an amazing idea, but don't know how to execute it? No worries! From <b>graphic designs</b> to <b>video production</b>, from <b>computer graphics</b> to <b>online web games</b>, I will help you <b>get your idea across</b> with
              compelling contents. </p>
          </div>
        </div>
        <div class="row mt-5" id="stats">
          <div class="col-md">
            <div class="text-center"><img src="img/home/code.svg"></div>
            <p>Lines of code written: <span class="h3" id="code"></span></p>
            <div class="text-center navi cl-effect-1"> <a href="computer-science.html">take a look</a> </div>
          </div>
          <div class="col-md">
            <div class="text-center"><img src="img/home/project.svg"></div>
            <p>Numbers of ad projects done: <span class="h3" id="ad"></span></p>
            <div class="text-center navi cl-effect-1"> <a href="advertising.html">take a look</a> </div>
          </div>
          <div class="col-md">
            <div class="text-center"><img src="img/home/graphic.svg"></div>
            <p>Numbers of visuals created: <span class="h3" id="visual"></span></p>
            <div class="text-center navi cl-effect-1"> <a href="digital-media-production.html">take a look</a> </div>
          </div>
        </div>
      </swiper-slide>
      <swiper-slide>
