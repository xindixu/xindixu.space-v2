      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <tabs pills tab-nav-classes="nav-pills-just-icons" type="primary">
            <tab-pane> <i slot="label" class="far fa-gem"></i> </tab-pane>
            <tab-pane>
              <i slot="label" class="fa fa-thermometer-full"></i>
            </tab-pane>
            <tab-pane> <i slot="label" class="fa fa-suitcase"></i> </tab-pane>
            <tab-pane disabled>
        ...
        <div class="col-md-6">
          ...
          <badge type="success">Success</badge> <badge type="info">Info</badge>
